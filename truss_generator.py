...
def Truss_Generator(seed):
    ...
    for _ in range(pc):
        ...
        n_div = rnd.randrange(n_min, n_max)
        div_inf = [rnd.randrange(3) for _ in range(n_div)]
        Trusses.append(Truss({"h1": h1, "h2": h2, "l": l, "n_div": n_div, "div_inf": div_inf}))
...
# Steel Catalogue
catalogue = {"S235": Steel(235, 360, 200000, 7850, 1.17e-5),
             "S275": Steel(275, 430, 200000, 7850, 1.17e-5),
             "S355": Steel(355, 510, 200000, 7850, 1.17e-5),
             "S450": Steel(440, 550, 200000, 7850, 1.17e-5)}
